...
Mat Draw_Guide_Line(Mat img)
{
   ...
   rectangle(result_img, Point(50, ASSIST_BASE_LINE - ASSIST_BASE_WIDTH), Point(IMG_Width-50, ASSIST_BASE_LINE + ASSIST_BASE_WIDTH),Scalar(152,160,237), 1, LINE_AA);
...
int main(void)
{
   ...
   ///////////////////////////////// OpenCV 변수 선언 //////////////////////
    ...
    mat_image_org_color = imread("/home/pi/Team_aMAP/Line_Tracer/2/images/line_1.jpg");
   ...
   while(1)
   {
     ...
     vector<Vec4i> linesP;
     HoughLinesP(mat_image_roi_canny_edge, linesP, 1, CV_PI/180,25,10,35);
